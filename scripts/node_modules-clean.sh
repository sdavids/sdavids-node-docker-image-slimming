...
find node_modules \( -name '.eslintrc' -o -name '.eslintrc.js' -o -name '.eslintrc.json'  -o -name '.eslintrc.yml' -o -name '.eslintrc.yaml' -o -name 'eslint.config.js' -o -name 'eslint.config.mjs' -o -name 'eslint.config.cjs' -type f \) -delete
...
find node_modules -iname 'OSSMETADATA' -type f -delete
