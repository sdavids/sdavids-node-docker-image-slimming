...
de.sdavids/sdavids-node-docker-image-slimming   latest  93.4MB
de.sdavids/sdavids-node-docker-image-slimming   local   93.4MB
...
4.76MB    COPY --chown=node:node /opt/app/dist/server.…
